...
function setup() {
    socket.on("modPanel", function(a) {
    if (a && a.enabled) {
        $("#mod_panel").show();
    }
});

socket.on("modResult", function(a) {
    $("#mod_result").text(a.message || "");
...
function sendInput() {
    $(document).on("click", "#mod_ban", function() {

    var username = $("#mod_username").val();
    var reason = $("#mod_reason").val();
    var unbanDate = $("#mod_unban").val();

    if (!username) {
        $("#mod_result").text("Enter a username.");
        return;
    }
...
$(document).on("click", "#mod_kick", function() {
